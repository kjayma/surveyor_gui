...
*/
  ...
  function show_dependency_value(data) {
    data = data.split(',');
    var pick = data[0];
    ...
    $('.dependency_number').hide();
    $('.dependency_text_box').hide();
    $('.dependency_date').hide();
    ...
    if (/multiple choice/.test(question_type)) {
      ...
      $('.dependency_text_box').show();
    }
    else if (question_type==='date'){
      $('.dependency_date').show();
    }
    else {
      $('.dependency_text').show();
    }
  }
