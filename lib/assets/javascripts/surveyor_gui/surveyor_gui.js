...
//  });
  ...
  $('.dependency_editor').on('change', 'select[id^="question_dependency_attributes_dependency_conditions_attributes"][id$="column_id"]', function(event) {
...
//      alert($(link).parent().prev().find('select').last().attr('id'));
  ...
  $.fn.refresh_dependency_answers = function() {
    var question_id =
      $(this).closest("tr").find('[id^="question_dependency_attributes_dependency_conditions_attributes"][id$="question_id"]').val();
    var column_id   =
      $(this).closest("tr").find('[id^="question_dependency_attributes_dependency_conditions_attributes"][id$="column_id"]').val();
    var dependency_condition_id =
      $(this).closest("tr").find('[id^="question_dependency_attributes_dependency_conditions_attributes"][id$="_id"]').val();
  ...
  $.fn.refresh_dependency_columns = function(question_type, question_id) {
    var column = $(this).closest('tr').find('[id^="question_dependency_attributes_dependency_conditions_attributes"][id$="column_id"]');
    var dependency_condition_id =
      $(this).closest("tr").find('[id^="question_dependency_attributes_dependency_conditions_attributes"][id$="_id"]').val();
